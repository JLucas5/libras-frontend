            ...
            <ul className= 'dictionary-list' id="dictionary">
                {dictionary.map(dictionary_item => (
                    <li key={dictionary_item._id}>
                        ...
                        <p>   
                            <Link to={"/dictionary/edit/" + dictionary_item._id}><button className='btn' id='editar'>editar</button></Link>
                            <button className='btn' id='excluir' onClick={event => deleteItem(dictionary_item._id)}>excluir</button>
                        </p>
                    </li>
                ))}
            </ul>

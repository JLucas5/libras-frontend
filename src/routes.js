  ...
  return (
    <BrowserRouter>
      <Switch>
        ...
        />
        <PrivateRoute path="/activity/edit/:id" component={EditActivity} />

        <PrivateRoute path="/dictionary" exact component={DictionaryList} />
        <PrivateRoute
          path="/dictionary/edit/:id"
          exact
          component={EditDictionaryItem}
        />
        <PrivateRoute path="/dictionary/new" component={NewDictionaryItem} />

        <PrivateRoute path="/module" exact component={ModuleList} />
        <PrivateRoute path="/module/new" component={NewModule} />
        <PrivateRoute path="/module/edit/:id" exact component={EditModule} />
        <PrivateRoute path="/module/view/:id" exact component={ViewModule} />

        <PrivateRoute path="/library/new/:type" component={NewLibraryItem} />
        <PrivateRoute path="/library/edit/:id" component={EditLibraryItem} />
        <PrivateRoute path="/library/:type" exact component={LibraryList} />

        <PrivateRoute path="/aboutus" exact component={AboutUs} />
        <PrivateRoute path="/aboutus/edit/:id" exact component={EditAboutUs} />
        <PrivateRoute path="/aboutus/new" exact component={NewAboutUs} />
      </Switch>
    </BrowserRouter>
  );
}
